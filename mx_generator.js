/**
 * ========================================================================
 * GENERATOR NATIVO NODE.JS DE ARCHIVOS .MX - PANEL MAESTRO MAXIMUS
 * ========================================================================
 * Genera archivos .MX cifrados (AES-256 + PBKDF2 + Maze Obfuscation).
 * Configuración Bloqueada (Protegida) al 100% excepto Nombre de Usuario y Contraseña.
 */
...
function generatePropertiesXml({ name, host, port = 22, user = "", pass = "", sni = "", payload = "" }) {
    ...
    const entries = {
        ...
        "file.proteger": "1", // <-- BLOQUEADO / PROTEGIDO AL 100%
        "file.msg": `Perfil MAXIMUS: ${name}`,
        "file.hideServerMessage": "0",
        "file.pedirLogin": "1", // <-- PERMITE INGRESAR USUARIO Y CONTRASEÑA EN LA APP
        "bloquearRoot": "0",
        "ssh_hwid": "0",
        "file.validade": "0",
