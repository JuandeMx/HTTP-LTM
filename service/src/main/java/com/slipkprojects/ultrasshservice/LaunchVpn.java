    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == START_VPN_PROFILE) {
            if (resultCode == Activity.RESULT_OK) {
				...
				if (prefs.getBoolean("use_v2ray", false)) {
					...
					if (prefs.getString("hysteria_host", "").isEmpty() && prefs.getString("unified_input", "").isEmpty()) {
						SkStatus.updateStateString("USER_VPN_PASSWORD_CANCELLED", "", R.string.state_user_vpn_password_cancelled,
							ConnectionStatus.LEVEL_NOTCONNECTED);
						...
						(mConfig.getPrivString(Settings.PROXY_IP_KEY) == null || mConfig.getPrivString(Settings.PROXY_IP_KEY).isEmpty() || mConfig.getPrivString(Settings.PROXY_PORTA_KEY) == null || mConfig.getPrivString(Settings.PROXY_PORTA_KEY).isEmpty())) {
					SkStatus.updateStateString("USER_VPN_PASSWORD_CANCELLED", "", R.string.state_user_vpn_password_cancelled,
						ConnectionStatus.LEVEL_NOTCONNECTED);
				...
				else if (mConfig.getPrivString(Settings.SERVIDOR_KEY) == null || mConfig.getPrivString(Settings.SERVIDOR_KEY).isEmpty() || mConfig.getPrivString(Settings.SERVIDOR_PORTA_KEY) == null || mConfig.getPrivString(Settings.SERVIDOR_PORTA_KEY).isEmpty()) {
					SkStatus.updateStateString("USER_VPN_PASSWORD_CANCELLED", "", R.string.state_user_vpn_password_cancelled,
						ConnectionStatus.LEVEL_NOTCONNECTED);
            	...
            	else if (!mConfig.getPrefsPrivate().getBoolean(Settings.HWID_AUTH_KEY, false) && 
						(mConfig.getPrivString(Settings.USUARIO_KEY) == null || mConfig.getPrivString(Settings.USUARIO_KEY).isEmpty() || 
						((mConfig.getPrivString(Settings.SENHA_KEY) == null || mConfig.getPrivString(Settings.SENHA_KEY).isEmpty()) &&
