...
public interface SettingsConstants
{
	...
	public static final String
		...
		HIDE_SERVER_MESSAGE_KEY = "hideServerMessage",
	...
	UDPFORWARD_KEY = "udpForward",
		...
		UDP_CUSTOM_CONF_KEY = "udpCustomConf",
		UDP_CUSTOM_OBFS_KEY = "udpCustomObfs",
		UDP_CUSTOM_UP_KEY = "udpCustomUp",
		UDP_CUSTOM_DOWN_KEY = "udpCustomDown";
